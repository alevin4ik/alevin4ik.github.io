...
function HelpToGame() {
    document.getElementById('game_set').innerHTML += Help_list + "<div id=\"CenterButton\"><button id=\"HelpButton\" onclick=\"style.display='none';HelpToGame()\">Правила</button></div>";
}
